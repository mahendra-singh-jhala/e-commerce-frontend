                ...
                <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4">
                    ...
                    <div className="lg:col-span-1 max-h-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24 mt-4">
                        <div className="lg:col-span-2">
                            <h1 className="text-lg lg:text-xl font-semibold text-gray-900"> {product?.data.product?.brand} </h1>
                            <h1 className="text-lg lg:text-xl text-gray-900 opacity-60 pt-1">{product?.data.product?.title}</h1>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <form className="mt-10">
                                ...
                                <Button onClick={handleSubmit} variant="contained" sx={{ bgcolor: "blueviolet", py: "16px", px: "32px", mt: "10px" }}>
                                    Add To Cart
                                </Button>
                            </form>
                        </div>
                        ...
                        <div className="py-10 lg:col-span-2 lg:col-start-1 lg:pb-16 lg:pr-8 lg:pt-6">
                            <div className="mt-4">
                                ...
                                <div className="space-y-6">
                                    <p className="text-base text-gray-900">{product?.data?.product?.description}</p>
                                </div>
                            </div>
                        </div>
                    </div>
